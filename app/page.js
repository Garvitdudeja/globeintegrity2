  ...
  const customerReviews = [
    {
      ...
      alt: "star",
      reviewText: "Globe Integrity has been my go- to insurance partner. Their expert team ensured I got the perfect coverage for my home and family.Prompt responses and hassle - free claims handling gave me peace of mind.Highly recommend! I trust these guys for all my insurance needs.",
  name: "Jess Apostol"
},
  {
    image: images.starsImg,
    alt: "star",
    reviewText: " Globe Integrity exceeded my expectations. Their personalized insurance options were exactly what I needed. The team's responsiveness and hassle-free claims process were impressive. Now I can rest easy, knowing I'm in good hands. Highly recommended for peace of mind.",
    name: "David"
    },
  {
    image: images.starsImg,
    alt: "star",
    reviewText: "Choosing Globe Integrity for my insurance needs was one of the best decisions I made. Their team guided me through the process, ensuring I had the perfect coverage for my home and family. Prompt responses and hassle-free claims handling have given me peace of mind.",
    name: "Kiara Hale"
    },
      {
    image: images.starsImg,
    alt: "star",
    reviewText: "Thanks to Globe Integrity, I finally found an insurance policy that perfectly suited my needs. Their friendly and knowledgeable team made the whole process effortless, and I feel confident knowing I'm in good hands for any future uncertainties.",
    name: "Kevin Martin"
    }
  ];
          ...
          <div className="col-12">
            ...
            >
              {customerReviews.map((review, index) => (
                <div className="customerCard" key={index + "W"}>
                  <Image
                    src={review.image}
            ...
            <div className="row align-items-center">
              ...
              <div className="col-6" >
                {stepsData.map((step, index) => (
                  <div className="stepsCard" key={index + "w"}>
                    <div>
        ...
        <div className="row justify-content-center  mb-4">
          <div className="col-xl-8">
            ...
            {faqData.map((item, index) => (
              <div className="row  faqItem" key={index + "w"}>
                <div className="col-lg-6">
